...
# データセットの分割を行う手法。
# 次節で使用するcross_val_scoreはこれを採用している。
    # StratifiedKFold
...
# それをGridSearchCVにSVC(Support Vector Classifier)と共に
# 渡してあげて実行する。
...
param_dist = {'n_estimators': range(4,20,2), 'min_samples_split': range(2,30,2), 'criterion':['gini','entropy']}
