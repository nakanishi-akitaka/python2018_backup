# -*- coding: utf-8 -*-
"""
Created on Fri Dec  7 15:10:58 2018
...
lwpls = LWPLS(n_components=n_components, l_similarity=l_similarity)
lwpls.fit(autoscaled_x_train, autoscaled_y_train)
estimated_y_test = lwpls.predict(autoscaled_x_test)
